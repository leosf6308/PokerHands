...
```{r}
sum(pokerTeste$resultado_previsto != pokerTeste$CLASS) / nrow(pokerTeste)
```
...
Quanto está OK?
```{r}
sum(pokerTreino$resultado != pokerTreino$CLASS) / nrow(pokerTreino)
sum(pokerTeste$resultado != pokerTeste$CLASS) / nrow(pokerTeste)
```
